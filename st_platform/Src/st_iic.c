...
/* variables ----------------------------------------------------------------*/
static at24_state_t st_mem_read(void*hi2c, uint16_t dev_adr , \
                         uint16_t mem_adr, uint16_t mem_adr_size, \
                         uint8_t *p_data, uint16_t size, \
                         uint32_t timeout);
static at24_state_t st_mem_write(void*hi2c, uint16_t dev_adr , \
                         uint16_t mem_adr, uint16_t mem_adr_size, \
                         uint8_t *p_data, uint16_t size, \
                         uint32_t timeout);
static at24_state_t st_dev_is_ready(void*hi2c, \
                              uint8_t dev_adr, \
                              uint32_t tails, \
                              uint32_t timeout);
                         ...
                         uint32_t timeout)
{
    ...
    uint32_t hal_ret = HAL_I2C_Mem_Read(p_hi2c, \
                            dev_adr,\
                            mem_adr,\
                            mem_adr_size, \
                            (uint8_t *)p_data, \
...
{
    I2C_HandleTypeDef *p_hi2c = (I2C_HandleTypeDef *)hi2c;
    uint32_t hal_ret = HAL_I2C_Mem_Write(p_hi2c, \
                            dev_adr,\
                            mem_adr,\
                            mem_adr_size, \
                            (uint8_t *)p_data, \
