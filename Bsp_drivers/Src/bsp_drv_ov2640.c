 ...
 *
 *@brief              :   OV2640 driver: SVGA config table, init sequence,
 *                        DCMI crop computation, and driver function binding.
 *
 *@version            :   V1.0
 *
 *@note               :   1 tab == 4 spaces!
...
/* CIF 模式寄存器配置表（传感器 400×296，DSP 输出 400×296 RGB565，~55fps）
 * 与 SVGA 的差异仅 8 处，其余完全一致：
 *   COM7=0x20, VEND=0x4c, BD50=0xca, BD60=0xa8,
 *   DSP 0xC0/C1/51/52 对应 CIF 传感器有效区 400×296               */
static const uint8_t ov2640_cif_cfg[][2] = {
    ...
    {0x09, 0x02}, // COM2，输出驱动能力
    {0x04, 0xA8}, // REG04，扫描方向等
    {0x12, 0x10}, // COM7，CIF 分辨率 bits[6:4]=001（SVGA 为 0x40=100）★
    {0x14, 0x48}, // COM9，增益设置
    {0x15, 0x00}, // COM10，极性控制
    {0x32, 0x09}, // REG32，像素时钟分频及窗口低3位
    {0x03, 0x86}, // COM1，无效帧及垂直窗口低2位
    ...
    {0xc0, 0x32}, // 图像水平尺寸 [10:3]：50×8=400（SVGA 为 0x64）★
    {0xc1, 0x25}, // 图像垂直尺寸 [10:3]：37×8=296（SVGA 为 0x4b）★
    {0x8c, 0x00},

    {0x50, 0x00}, // CTRLI，水平/垂直分频器
    {0x51, 0x64}, // 水平尺寸 [9:2]：100×4=400（SVGA 为 0xc8）★
    {0x52, 0x4a}, // 垂直尺寸 [9:2]：74×4=296（SVGA 为 0x96）★
    {0x53, 0x00}, {0x54, 0x00}, {0x55, 0x00}, {0x57, 0x00},

    {0xd3, 0x80}, // R_DVP_SP，PCLK 自动
